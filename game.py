...
class PongGame(Widget):
    ...
    def update(self, dt):
        ...
        actions = [None, None]
        actions[0] = self.player1_ai.choose_action() if self.ai_players[0] == 1 else None
        actions[1] = self.player2_ai.choose_action() if self.ai_players[1] == 1 else None
        self.step(actions)
    ...
    def observation(self, player):
        if player == 0:
            obs = [self.player1.game_y / 35, self.player2.game_y / 35, round(self.ball.game_x / 78, 3),
                   round(self.ball.game_y / 43, 3), round((self.ball.velocity_x + 2.5) / 5, 3),
                   round((self.ball.velocity_y + 2.5) / 5, 3)]
        if player == 1:
            obs = [self.player1.game_y / 35, self.player2.game_y / 35, round(self.ball.game_x / 78, 3),
                   round(self.ball.game_y / 43, 3), round((self.ball.velocity_x + 2.5) / 5, 3),
                   round((self.ball.velocity_y + 2.5) / 5, 3)]
